  ...
  const drawer = (
    <div>
      ...
      <List>
        ...
        <ListItem button component={Link} href="/ghas">
          <ListItemIcon>
            <HandymanIcon />
          </ListItemIcon>
          <ListItemText primary="GHAs" />
        </ListItem>
        ...
        <ListItem button component={Link} href="/aircraft-size-categories">
          <ListItemIcon>
            <CategoryIcon />
          </ListItemIcon>
          <ListItemText primary="Size Categories" />
        </ListItem>
