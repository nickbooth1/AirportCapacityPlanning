...
import { Card, Select, Spin, Typography, Space, Tooltip, Button } from 'antd';
...
const ComparativeCapacityChart = ({
  ...
  const chartComponent = useMemo(() => {
    if (!chartData) return <div className="empty-chart">No data available</div>;
  ...
  return (
    <Card className="comparative-capacity-chart">
      <Space direction="vertical" style={{ width: '100%' }}>
        <TitleText level={4}>Comparative Capacity Analysis</TitleText>
