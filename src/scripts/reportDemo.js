...
console.log('reportGenerator module loaded successfully');
...
function runDemo() {
  try {
    console.log('Function runDemo started');
    ...
    console.log('Calling generateValidationReport...');
    ...
    console.log('Report generated successfully:', report ? 'valid object' : 'null or undefined');
...
console.log('About to call runDemo');
// Run the demo
runDemo(); 