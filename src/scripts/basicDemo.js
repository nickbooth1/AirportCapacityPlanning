/**
 * Simple Flight Schedule Validator Report Generator Demo
 * Demonstrates just the report generation capabilities using mock data
 * 
 * Usage: node src/scripts/basicDemo.js [output-format]
...
function runDemo() {
  try {
    console.log('Basic Report Generator Demo');
    console.log('==========================\n');
    ...
    console.log('Generating validation report from mock data...');
    ...
    if (outputFormat === 'json' || outputFormat === 'all') {
      const jsonPath = path.join(outputDir, 'basic-report.json');
    ...
    if (outputFormat === 'csv' || outputFormat === 'all') {
      const csvPath = path.join(outputDir, 'basic-report.csv');
    ...
    if (outputFormat === 'html' || outputFormat === 'all') {
      const htmlPath = path.join(outputDir, 'basic-report.html');
